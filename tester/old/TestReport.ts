...
export class TestReport {
    ...
    public storeReport(location: string) {
        ...
        try {
            ...
            logger.info("Report stored in " + location);
        } catch (error) {
            logger.error("Report couldnt be stored")
        }
